...
# Initialisiere Pygame und Mixer
pygame.init()
mixer.init()
...
# Spieler erstellen
fighter_1 = Champion(1, 200, 310, animations_zuko, dragon_slayer_fx)
fighter_2 = Champion(2, 700, 310, animations_susanoo, katana_fx)

# Initialisierung der Spiel-Logik
game_logic = GameLogic(fighter_1, fighter_2, fonts, colors, screen, lambda text, font, color, x, y: draw_text(text, font, color, x, y))
...
def main_menu():
    ...
    animated_button = AnimatedButton(button_image_paths, SCREEN_WIDTH // 2 - button_width // 2, SCREEN_HEIGHT // 2 - button_height // 2, button_width, button_height)
